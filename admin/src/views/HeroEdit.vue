    ...
    <el-form label-width="120px" @submit.native.prevent="save">
      <el-tabs value="basic" type="border-card">
        ...
        <el-tab-pane label="最佳搭档">
          <el-button type="text" @click="model.partners.push({})"><i class="el-icon-plus">添加搭档</i></el-button>
          <el-row :gutter="10" type="flex" style="flex-wrap: wrap">
...
export default {
  ...
  methods: {
    ...
    async save() {
      if(this.id) {
        await this.$http.put(`heroes/${this.id}`, this.model)
      } else {
        await this.$http.post('heroes', this.model)
      }
